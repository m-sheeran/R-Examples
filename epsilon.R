...
epsilon = function(filename1, filename2, skulist)
{
  ...
  #NOTE: RIGHT JOIN SKULIST TO ENSURE YOU GET NA'S FOR SKU NOT ON DF
  ...
  # set NA's = 0
  sub2[ , totalOpen := OctOpen + NovOpen]
  sub2[ , totalShipped := OctShipped + NovShipped]
